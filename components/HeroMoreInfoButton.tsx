...
const HeroMoreInfoButton: React.FC<HeroMoreInfoButtonProps> = ({
    ...
    return (
        <button
            ...
            className={`flex items-center justify-center bg-[#6d6d6e]/50 text-white px-5 sm:px-8 h-[35px] md:h-[45px] rounded-[4px] font-bold hover:bg-[#6d6d6e]/35 backdrop-blur-sm transition-colors duration-150 active:scale-95 text-[15px] md:text-[18px] gap-2 pointer-events-auto ${className}`}
        >
